...
import { Dictionary, Partner } from "@/dictionaries/types";
    ...
    <div className="space-y-4">
        {partner.email && (
            <FadeInHero delay={0.65}>
                <div className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm transition-colors hover:border-[#C8A97E]/50">
                        ...
                        <div className="lg:col-span-4">
                            <div className="lg:sticky lg:top-28">
                                ...
                                <div className="mt-6 hidden lg:block">
                                    <InfoCards partner={partner} dict={dict} />
                                </div>
                            </div>
                        </div>
